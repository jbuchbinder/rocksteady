...
/**
 * This class defines all the default constants which will be used when they can not be found
 * in the r2d2.properties file.
 */
public class DefaultConfig {
    ...
    /**
     * The default number of IO threads to use.  This will be set to number of cores + one.
     */
   ...
   /**
     ...
     *
     * NOTE:
     *      By default esper threading is disabled.  Care should be taken if it needs to
     *      enabled since the send and callback events occur in different threads.
     */
