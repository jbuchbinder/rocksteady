...
public class Threshold {
    ...
    public Integer deleteOldRecord(Long cutOffTime) { 
	    ...
	    long currentTime = new Date().getTime() / 1000;  // seconds since midnight Jan 1, 1970
	    String query = "delete from Threshold o where (" + currentTime + " - UNIX_TIMESTAMP(create_on))" + " > " + cutOffTime;
	    logger.debug(query);
