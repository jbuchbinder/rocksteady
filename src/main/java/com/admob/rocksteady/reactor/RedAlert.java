...
public class RedAlert implements UpdateListener  {
    ...
    /**
     * Set the default id for this listener.  If not set then the id is extracted from the
     * Event.
     *
    ...
    public void update(EventBean[] newEvents, EventBean[] oldEvents) {
        ...
        for (EventBean newEvent : newEvents) {
        	try {
                ...
                logger.info(" Problem!! " + colo + " - " + name + " with " + value + " exceeded threshold of " + threshold);
