...
public class GraphiteInterface
{
   ...
   * 
   * @param graphiteServer is the server name hosting Graphite such as "graphite.sc9.admob.int".
  ...
  public void send( String input )
  {
    ...
    if ( enableSend ) {
	    ...
	    {
	      LOG.warn( "Cannot resolve the Graphite server hostname:  " + graphiteServer + ".  Are you sure it is configured correctly?  Will save the data and try again." );
	      saveStats( data );
