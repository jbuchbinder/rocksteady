...
public class ClassHelper {
    ...
    public static Field findField(Class clazz, String fieldName) {
        ...
        if (fields.size() == 0) {
            throw new RuntimeException("ClassHelper.findField: Could not find Field with name for given Class -- ClassName: " + clazz.getName() + " -- FieldName: " + fieldName);
        }
        if (fields.size() != 1) {
            throw new RuntimeException("ClassHelper.findField: Could not find Field with name for given Class -- ClassName: " + clazz.getClass().getName() + " -- FieldName: " + fieldName);
        }
        return (fields.get(0));
    }
